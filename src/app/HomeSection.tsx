            ...
            <div className="grid grid-cols-12 h-full gap-x-16">
                <div className="col-span-8 flex flex-col justify-center gap-8">
                    ...
                    <div className="flex gap-5">
                        <a href="https://www.linkedin.com/in/fadi-gorges-174a88246/" className="group">
                            <svg fill="currentColor"
                                 className="group-hover:text-primary group-hover:drop-shadow-[0_3px_.8px_rgba(0,0,0,0.25)] transition group-active:scale-90"
                        ...
                        <a href="https://github.com/fadi-gorges" className="group">
                            <svg fill="currentColor"
                                 className="group-hover:text-primary group-hover:drop-shadow-[0_3px_.8px_rgba(0,0,0,0.25)] transition group-active:scale-90"
                                 xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
                                <path
